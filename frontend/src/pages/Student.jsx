...
export default function Student() {
  ...
  return (
    <section style={{ maxWidth: 760, margin: '0 auto', padding: '40px 32px' }}>
      ...
      <div className="fade-up">
        ...
        <h1 style={{ fontSize: 48, fontWeight: 900, letterSpacing: '-0.025em', lineHeight: 1.1 }}>
        ...
        <div style={{ display: 'flex', gap: 12, marginTop: 36, flexWrap: 'wrap' }}>
          ...
          >
            <span style={{ fontSize: 22, fontWeight: 900, letterSpacing: '-0.02em' }}>Пробники</span>
          ...
          <Link
            ...
            onMouseLeave={(e) => { e.currentTarget.style.background = 'white'; e.currentTarget.style.borderColor = 'var(--black)'; }}
          >
            <span style={{ fontSize: 22, fontWeight: 900, letterSpacing: '-0.02em' }}>Карта ошибок марафона</span>
          ...
          <Link
            ...
            onMouseLeave={(e) => { e.currentTarget.style.background = 'white'; e.currentTarget.style.borderColor = 'var(--black)'; }}
          >
            <span style={{ fontSize: 22, fontWeight: 900, letterSpacing: '-0.02em' }}>Учебный год</span>
