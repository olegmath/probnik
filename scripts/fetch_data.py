...
def main():
    ...
    sheet_names = [
        ...
        # Финал — результаты реального экзамена. Конвенция: «<предмет> экз»
        # (именно с маленькой — gviz матчит имя листа с учётом регистра).
        # Отсутствующие листы скипаются sheet_has_expected_rows — добавлять безопасно.
        'ФИЗ ЕГЭ экз',
        'ФИЗ ОГЭ экз',
        'ИНФ ЕГЭ экз',
        'ИНФ ОГЭ экз',
